...
| Canonical 回测证据 | `BACKTEST_BUNDLE_SCHEMA_VERSION`、`BacktestEvidenceTier`、`BacktestBundleManifest`、`reconcile_unified_ledger`、`validate_execution_aware_bundle_inputs`、`write_backtest_bundle`、`read_backtest_bundle` |
